<!DOCTYPE html>
    ...
    <body>
        @isset($customers)
            <ul>
                @foreach($customers as $customer)
                    <li><a href="/api/customer/{{$customer->id}}">{{ $customer->first_name }} {{ $customer->last_name }}</a></li>
                @endforeach
            </ul>
            <hr />
        ...
        @isset($singleCustomer)
            <h3>{{ $singleCustomer->first_name }} {{ $singleCustomer->last_name }}</h3>
            <h4>{{ $singleCustomer->email }}</h4>
            <h5>{{ $singleCustomer->created_at }}</h5>
            <h5>Carts:</h5>
            <ul>
            @foreach($singleCustomer->carts as $cart)
                    <li><a href="/api/cart/{{$cart->id}}">Cart {{$cart->id}}: {{$cart->status}}</a></li>
            @endforeach
            </ul>
            <h5>Orders:</h5>
            <ul>
