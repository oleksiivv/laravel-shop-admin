    ...
    <body>
        @isset($manufacturers)
            <ul>
                @foreach($manufacturers as $manufacturer)
                    <li><a href="/api/product-manufacturer/{{$manufacturer->id}}">{{ $manufacturer->name }} {{ $manufacturer->raiting }}</a></li>
                @endforeach
            </ul>
            <hr />
        ...
        @isset($singleManufacturer)
            ...
            <div class="alert alert-dark">
                ...
                <form method="POST" action="/api/product-manufacturer/{{$singleManufacturer->id}}/delete">
                    @csrf
                    <input type="submit" class="btn btn-danger" value="Delete"/>
                </form>

                <form method="POST" action="/api/product-manufacturer/{{$singleManufacturer->id}}/products/delete">
                    @csrf
